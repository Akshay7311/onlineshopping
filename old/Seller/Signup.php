...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO `seller` (`seller_id`, `first_name`, `last_name`, `Email`, `Username`, `Password`, `Phone_number`, `address_line1`, `address_line2`, `Acc_no`, `Bank_Name`, `Branch`, `Ifsc_Code`, `country`, `city`, `state`, `pincode`, `Registration_date`) 
    VALUES 
