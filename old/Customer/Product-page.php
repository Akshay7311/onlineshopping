...
<body>
        ...
        <main>
            <div class="product-container">
                ...
                if ($result && mysqli_num_rows($result) > 0) {
                    ...
                    $image = isset($productDetails['image_images']) ? $productDetails['image_images'] : '';
                    $imagePath = '../images/' . $image;
                ?>
                    <!-- Display product image -->
                    <div class="product-details">
                        <img class="product-image" src='<?php echo $imagePath; ?>' alt="Product Image" onerror="this.src='../404-error-page-header-transparent.webp'">
                    </div>
            ...
            <div class="product-desc">
                ...
                ?>
                    ...
                    <h3><b>Price</b> : ₹<?php echo $productDetails['Price']; ?></h3>
    ...
    <footer>
        <div class="container-1">
            ...
            <p class="description">Welcome to our Online Shopping,Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis quam asperiores aliquam ad corporis labore eaque aperiam, distinctio, inventore odio facilis odit mollitia laboriosam. Dolore beatae aspernatur tempore illo laudantium ipsa commodi dicta laboriosam iure!</p>
        </div>
    </footer>
</body>
</html>