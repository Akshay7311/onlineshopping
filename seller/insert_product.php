...
<body bgcolor="skyblue">
    ...
    <form action=" " method="post" enctype="multipart/form-data">
        <!-- entype= multitype means we will receive data in multiple formats like images or may be videos -->
...
<?php
    ...
    if (isset($_POST['insert_post'])) {
        ...
        //$product_id = 1;
        $query = "insert into products  values ('$seller_id','$product_cat','$product_brand','$product_title','$product_price','$product_desc','$product_image','$product_keywords','')";
